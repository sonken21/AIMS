package com.aims.group19.entity.media;
...
public class DVD extends Media {
    ...
    public DVD(int id, String title, String category, int value, int price, int quantity, String type, String imageURL, double weight, String discType,
            String director, int runtime, String studio, String subtitles, Date releasedDate, String filmType) throws SQLException{
        super(id, title, category, value, price, quantity, type, imageURL, weight);
